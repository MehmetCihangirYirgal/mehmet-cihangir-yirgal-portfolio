(function () {
  ...
  // Language is no longer a runtime toggle: each page (/ for English, /tr/ for Turkish) is a
  // separate static HTML file generated by build-lang-pages.js, with its own fixed `lang` /
  // `data-lang` attribute baked in and a plain link to the other language's page. See that
  // script for the EN/TR split — this file only ever runs against a single, fixed language.
